...
public class VisualOptimizerMultiplayer : MonoBehaviour
{
    
    public ProcGennerMultiplayer m_ProcGen;
    ...
    void Update()
    {
            ...
            {
                List<ProcGennerMultiplayer.RoomDef> rooms = this.m_ProcGen.GetRoomDefs();
                for (int i=0; i<rooms.Count; i++)
                {
                    ProcGennerMultiplayer.RoomDef room = rooms[i];
    ...
    bool PlayerCanSeeRoom(ProcGennerMultiplayer.RoomDef room)
    {
